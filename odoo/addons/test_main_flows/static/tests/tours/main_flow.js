...
...tour.stepUtils.statusbarButtonsSteps('Set All Done', _t("Set All Done"), ".o_statusbar_status .btn.dropdown-toggle:contains('Ready')"),
...tour.stepUtils.statusbarButtonsSteps('Validate', _t("Validate")),
{

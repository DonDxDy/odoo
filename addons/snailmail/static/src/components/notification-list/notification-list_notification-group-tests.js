odoo.define('snailmail/static/src/components/notification-list/notification-list_notification-group-tests.js', function (require) {
'use strict';
...
QUnit.module('notification-list', {}, function () {
QUnit.module('notification-list_notification-group-tests.js', {
    beforeEach() {
        beforeEach(this);
        ...
        this.createNotificationListComponent = async ({ filter = 'all' } = {}) => {
            await createRootComponent(this, NotificationList, {
                props: { filter },

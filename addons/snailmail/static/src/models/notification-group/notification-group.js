odoo.define('snailmail/static/src/models/notification-group/notification-group.js', function (require) {
'use strict';
...
const actionExtensions = defineActionExtensions({
    ...
    'NotificationGroup/openCancelAction'(
        ...
        if (notificationGroup.$$$type(this) !== 'snail') {
...
return defineFeatureSlice(
    'snailmail/static/src/models/notification-group/notification-group.js',
    actionExtensions,
);

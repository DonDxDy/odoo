...
class StorageCategory(models.Model):
    ...
    capacity_ids = fields.One2many('stock.storage.category.capacity', 'storage_category_id')
    ...
    def copy(self, default=None):
        ...
        for capacity in self.capacity_ids:
            capacity.copy({'storage_category_id': res.id})
        return res
...
class StorageCategoryProductCapacity(models.Model):
    ...
    storage_category_id = fields.Many2one('stock.storage.category', ondelete='cascade', required=True)

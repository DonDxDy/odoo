...
class Meeting(models.Model):
    ...
    mon = fields.Boolean('Mon', compute='_compute_recurrence', readonly=False)
    tue = fields.Boolean('Tue', compute='_compute_recurrence', readonly=False)
    wed = fields.Boolean('Wed', compute='_compute_recurrence', readonly=False)
    thu = fields.Boolean('Thu', compute='_compute_recurrence', readonly=False)
    fri = fields.Boolean('Fri', compute='_compute_recurrence', readonly=False)
    sat = fields.Boolean('Sat', compute='_compute_recurrence', readonly=False)
    sun = fields.Boolean('Sun', compute='_compute_recurrence', readonly=False)

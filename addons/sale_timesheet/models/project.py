...
class ProjectTask(models.Model):
    ...
    @api.depends('sale_line_id', 'project_id', 'allow_billable', 'bill_type', 'pricing_type')
    def _compute_sale_order_id(self):
        for task in self:
            if task.allow_billable and task.bill_type == 'customer_project' and task.pricing_type == 'employee_rate':

...
class AccountMove(models.Model):
    ...
    analytic_account_lines_ids = fields.One2many('account.analytic.line', compute='_compute_analytic_account_lines_ids')

    @api.depends('line_ids.analytic_line_ids')
    def _compute_analytic_account_lines_ids(self):
        for move in self:
            acl = move.line_ids.analytic_line_ids
            move.analytic_account_lines_ids = acl

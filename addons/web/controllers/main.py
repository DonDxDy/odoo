...
from odoo.tools import image_process, html_escape, pycompat, ustr, apply_inheritance_specs, lazy_property, float_repr
...
class HomeStaticTemplateHelpers(object):
    ...
    def _get_qweb_templates(self):
        ...
        addon_files = IrAsset.get_addon_files(addons=self.addons, bundle='qweb', xml=True)

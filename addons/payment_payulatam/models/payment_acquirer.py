...
class PaymentAcquirer(models.Model):
    ...
    def _payulatam_generate_sign(self, inout, values):
        ...
        if inout == 'in':
            ...
            data_string = '~'.join([
                ...
                # PayUlatam is using a rounded value to generate their signature
                # despite saying otherwise in the doc:
    ...
    def _payulatam_get_redirect_url(self):
        self.ensure_one()
    ...
    def _get_compatible_acquirers(self, *args, currency_id=None, **kwargs):
        ...
        if currency.name not in PAYULATAM_SUPPORTED_CURRENCIES:

...
const InvitePartnerDialog = require('mail/static/src/widgets/discuss-invite-partner-dialog/discuss-invite-partner-dialog.js');
...
const DiscussWidget = AbstractAction.extend({
    ...
    async willStart() {
        ...
        await this.env.messagingCreated;
    ...
    _onClickMarkAllAsRead() {
        this.env.invoke('Message/markAllAsRead', this.domain);
    },
    /**
     * @private
     */
    ...
    _onClickModerationAccept() {
        this.env.invoke('Message/moderateMessages',
     ...
     */
    _onClickSelectAll() {
        this.env.invoke('Message/checkAll',
            this.discuss.$$$thread(),
     ...
     */
    _onClickUnselectAll() {
        this.env.invoke('Message/uncheckAll',
            this.discuss.$$$thread(),
            this.discuss.$$$stringifiedDomain()
        );
    },
     ...
     */
    _onClickUnstarAll() {
        this.env.invoke('Message/unstarAll');
    },
    /**
     * @private

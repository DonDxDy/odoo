odoo.define('mail/static/src/widgets/messaging-menu/messaging-menu.js', function (require) {
'use strict';

const MessagingMenu = require('mail/static/src/components/messaging-menu/messaging-menu.js');

odoo.define('mail/static/src/widgets/form-renderer/form-renderer.js', function (require) {
"use strict";

const ChatterContainer = require('mail/static/src/components/chatter-container/chatter-container.js');
...
FormRenderer.include({
    ...
    _makeChatterContainerComponent() {
        ...
        if (this.chatterFields.hasRecordReloadOnFollowersUpdate) {
            owl.Component.env.bus.on('Thread:promptAddFollower-closed', this, ev => this.trigger_up('reload'));
        }
    },
    /**
     * @private

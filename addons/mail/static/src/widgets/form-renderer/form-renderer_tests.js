odoo.define('mail/static/src/widgets/form-renderer/form-renderer_tests.js', function (require) {
"use strict";
...
QUnit.module('form-renderer', {}, function () {
QUnit.module('form-renderer_tests.js', {
    beforeEach() {
        beforeEach(this);
        ...
        this.createView = async (viewParams, ...args) => {
            await afterNextRender(async () => {
                ...
                const env = await start(viewArgs, ...args);
                this.env = env;
                return env;
            });
        };
...
QUnit.skip('basic chatter rendering', async function (assert) {
    ...
    assert.strictEqual(
        document.querySelectorAll('.o-Chatter').length,
        1,

odoo.define('mail/static/src/utils/test-utils.js', function (require) {
'use strict';
...
const {
    addTimeControlToEnv,
} = require('mail/static/src/env/test-env.js');
const usingModels = require('mail/static/src/env-mixins/using-models/using-models.js');
const ChatWindowService = require('mail/static/src/services/chat-window-service/chat-window-service.js');
const DialogService = require('mail/static/src/services/dialog-service/dialog-service.js');
...
const MessagingMenuWidget = require('mail/static/src/widgets/messaging-menu/messaging-menu.js');
...
async function start(param0 = {}) {
    ...
    const start = async () => {
        if (waitUntilMessagingCondition === 'created') {
            await testEnv.messagingCreated;
        }
        if (waitUntilMessagingCondition === 'initialized') {
            await testEnv.messagingInitialized;
        }

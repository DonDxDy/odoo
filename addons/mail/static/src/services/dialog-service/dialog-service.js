odoo.define('mail/static/src/services/dialog-service/dialog-service.js', function (require) {
'use strict';

const DialogManager = require('mail/static/src/components/dialog-manager/dialog-manager.js');

odoo.define('mail/static/src/components/thread-needaction-preview/thread-needaction-preview_tests.js', function (require) {
'use strict';
...
QUnit.module('thread-needaction-preview', {}, function () {
QUnit.module('thread-needaction-preview_tests.js', {
    beforeEach() {
        beforeEach(this);

        this.createThreadNeedactionPreviewComponent = async props => {
            await createRootComponent(this, ThreadNeedactionPreview, {
                props,

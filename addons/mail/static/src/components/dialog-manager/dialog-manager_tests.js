odoo.define('mail/static/src/components/dialog-manager/dialog-manager_tests.js', function (require) {
'use strict';
...
QUnit.module('dialog-manager', {}, function () {
QUnit.module('dialog-manager_tests.js', {
    beforeEach() {
        beforeEach(this);

odoo.define('mail/static/src/components/discuss/tests/discuss-inbox_tests.js', function (require) {
'use strict';
...
QUnit.module('discuss-inbox_tests.js', {
    beforeEach() {
        beforeEach(this);
...
QUnit.test('reply: discard on discard button click', async function (assert) {
    ...
    await afterNextRender(() =>
        document.querySelector('.o-Composer-buttonDiscard').click()
    );
    assert.containsNone(
        document.body,
        '.o-Composer',
...
QUnit.test('reply: discard on click away', async function (assert) {
    ...
    document.querySelector('.o-ComposerTextInput-textarea').click();
    ...
    await afterNextRender(() => {
        document.querySelector('.o-EmojisPopover-emoji').click();
    });
    assert.containsNone(
        document.body,
        '.o-EmojisPopover',
    ...
    await afterNextRender(() =>
        document.querySelector('.o-Message').click()
    );
    assert.containsNone(
        document.body,
        '.o-Composer',
...
QUnit.test('click on (non-channel/non-partner) origin thread link should redirect to form view', async function (assert) {
    ...
    document.querySelector('.o-Message-originThreadLink').click();
    assert.verifySteps(
        ['do-action'],

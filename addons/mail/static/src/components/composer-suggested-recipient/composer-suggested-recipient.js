odoo.define('mail/static/src/components/composer-suggested-recipient/composer-suggested-recipient.js', function (require) {
'use strict';
...
class ComposerSuggestedRecipient extends usingModels(Component) {
    ...
    _onChangeCheckbox() {
        ...
        this.env.invoke('Record/update', this.suggestedRecipientInfo, {
    ...
    _onDialogSaved() {
        ...
        this.env.invoke('Thread/fetchAndUpdateSuggestedRecipients', thread);
    }
}

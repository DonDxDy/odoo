odoo.define('mail/static/src/component-hooks/useStore/useStore_tests.js', function (require) {
'use strict';

const useStore = require('mail/static/src/component-hooks/useStore/useStore.js');
const {
    afterNextRender,
    nextAnimationFrame,
...
QUnit.module('component-hooks', {}, function () {
QUnit.module('useStore', {}, function () {
QUnit.module('useStore_tests.js', {
    beforeEach() {
        const qweb = new QWeb();
        this.env = { qweb };
    },
